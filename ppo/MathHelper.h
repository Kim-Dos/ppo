...
public:
	...
	static void ScreenToRay( int screenX, int screenY, int screenWidth, int screenHeight, const DirectX::XMMATRIX& viewMatrix, const DirectX::XMMATRIX& projMatrix, DirectX::XMVECTOR& outRayOrigin, DirectX::XMVECTOR& outRayDirection);
